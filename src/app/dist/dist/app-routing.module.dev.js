...
var redirectUnauthorizedToLogin = function redirectUnauthorizedToLogin() {
  return auth_guard_1.redirectUnauthorizedTo(['login']);
};

var redirectLoggedInToHome = function redirectLoggedInToHome() {
  return auth_guard_1.redirectLoggedInTo(['home']);
};
...
// ...
{
  ...
  loadChildren: function loadChildren() {
    return Promise.resolve().then(function () {
      return require('./folder/folder.module');
    }).then(function (m) {
...
}, // Páginas que solo se pueden acceder si el usuario está autenticado
{
  ...
  loadChildren: function loadChildren() {
    return Promise.resolve().then(function () {
      return require('./contacto/contacto.module');
    }).then(function (m) {
